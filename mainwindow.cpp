...
{
    double final_class_score = ((hw1 + hw2 + hw3 + hw4 + hw5 + hw6 + hw7 + hw8)/800.0)*25 + (midterm1*20)/100.0 + (midterm2*20)/100.0 + (final_exam_score*35)/100;
...
void MainWindow::on_Scheme_B_Selection_clicked()
{
    ...
    double final_class_score = ((hw1 + hw2 + hw3 + hw4 + hw5 + hw6 + hw7 + hw8)/800.0)*25 + (max_midterm*30)/100 + (final_exam_score*44)/100;
    string q = std::to_string(final_class_score);
    QString qstr = QString::fromStdString(q);
    ui->Final_Score_Display->setText(qstr);
}
